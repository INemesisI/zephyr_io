...
static void stream_consumer1_handler(struct flow_sink *sink, struct net_buf *buf)
{
...
static void stream_consumer2_handler(struct flow_sink *sink, struct net_buf *buf)
{
...
static void bulk_processor_handler(struct flow_sink *sink, struct net_buf *buf)
{
