...
static void led_controller_cmd_handler(struct flow_sink *sink, struct net_buf *buf)
{
...
FLOW_SINK_DEFINE_IMMEDIATE(led_controller_sink, led_controller_cmd_handler);
