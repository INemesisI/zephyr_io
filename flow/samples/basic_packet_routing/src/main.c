...
FLOW_CONNECT(&sensor1_source, &processor_sink);
FLOW_CONNECT(&sensor2_source, &processor_sink);
FLOW_CONNECT(&processor_source, &tcp_sink);
FLOW_CONNECT(&processor_source, &validator_sink);
