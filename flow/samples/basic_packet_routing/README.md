# Flow Basic Sample - Modular Packet Routing

This sample demonstrates advanced flow concepts through a modular, multi-stage packet processing pipeline with integrity validation.
...
[00:00:00.000] <inf> main: Flow Routing Sample
...
**Build errors**: Ensure `ZEPHYR_EXTRA_MODULES` points to flow module
