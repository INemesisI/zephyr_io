...
static void led_controller_cmd_handler(struct swift_io_sink *sink, struct net_buf *buf)
{
...
SWIFT_IO_SINK_DEFINE_IMMEDIATE(led_controller_sink, led_controller_cmd_handler);
