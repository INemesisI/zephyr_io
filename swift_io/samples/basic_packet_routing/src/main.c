...
SWIFT_IO_CONNECT(&sensor1_source, &processor_sink);
SWIFT_IO_CONNECT(&sensor2_source, &processor_sink);
SWIFT_IO_CONNECT(&processor_source, &tcp_sink);
SWIFT_IO_CONNECT(&processor_source, &validator_sink);
