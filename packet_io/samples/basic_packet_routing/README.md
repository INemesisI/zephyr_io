# Packet I/O Basic Sample - Modular Packet Routing

This sample demonstrates advanced packet_io concepts through a modular, multi-stage packet processing pipeline with integrity validation.
...
[00:00:00.000] <inf> main: Packet I/O Routing Sample
...
**Build errors**: Ensure `ZEPHYR_EXTRA_MODULES` points to packet_io module

## Further Reading

- [Packet I/O Design Document](../../packet_io_design.md)
