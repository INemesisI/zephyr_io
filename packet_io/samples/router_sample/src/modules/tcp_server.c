...
static void tcp_server_tx_handler(struct packet_sink *sink, struct net_buf *buf);

/* TCP server packet I/O interfaces */
PACKET_SOURCE_DEFINE(tcp_server_source); /* TCP receive - packets from network */
PACKET_SINK_DEFINE_IMMEDIATE(tcp_server_sink,
